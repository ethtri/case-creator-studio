...
const PET_PHOTO_IMAGE = `${SITE_URL}/marketing/pet-photo-landing/pet-photo-case-product-concept-social-preview-landscape.webp`;
...
export const staticSeoPages: StaticSeoPage[] = [
  ...
  },
  {
    ...
    headline: "Create a custom Samsung Galaxy case.",
    intro:
